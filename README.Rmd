...
event data in R/ggplot2 from a variety of data providers.
...
Since this argument just requires a function, you can modify the supplied functions, 
or create your own goal markings function.

The `goals` argument also supports using one-sided formulas as lambda functions
(see [`rlang::as_function`](https://rlang.r-lib.org/reference/as_function.html))
to modify or extend the existing goals functions:

```{r example_goals_custom, message=FALSE}
