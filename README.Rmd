...
Because coord-flip reverses the orientation of the points, we must also reverse the y-axis
...
NOTE: Ordinarily, we would do this with `scale_y_reverse`. However, due to
